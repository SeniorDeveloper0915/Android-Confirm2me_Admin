    ...
    <form id="userCreate" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group form-md-line-input form-md-floating-label">
                        ...
                        <input type="text" id="username" name="username" class="form-control input-sm" data-required="true"
                               value="">
                    ...
                    <div class="form-group form-md-line-input form-md-floating-label">
                        ...
                        <input type="text" id="pin" name="pin" class="form-control input-sm"
                               data-required="true" value="">
     ...
     <!--                <div class="form-group form-md-radios">
                    ...
                    <div class="form-group ">
                        <div class="fileinput fileinput-new" data-provides="fileinput">
                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                <img  src="http://www.placehold.it/200x150/EFEFEF/AAAAAA" alt="" /> </div>
        ...
        <div class="modal-footer">
            ...
            <button type="submit" class="btn green btn-outline" name="submit" onclick="createUser();return false">Create</button>
        </div>
